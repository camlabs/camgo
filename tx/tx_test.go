...
import (
	...
	"github.com/camlabs/camgo/keystore"
...
func TestNep5RPC(t *testing.T) {
	...
	client := rpc.NewClient(conf.GetString("cam", "xxxxx"))
...
func getAsset(address string, asset string) ([]*rpc.UTXO, error) {
	client := rpc.NewClient(conf.GetString("cam", "xxxxx") + "/extend")
...
func TestMintToken(t *testing.T) {
	...
	client := rpc.NewClient(conf.GetString("camtest", "xxxxx"))
...
func TestTransfer(t *testing.T) {
	client := rpc.NewClient(conf.GetString("camtest2", "xxxxx"))
